...
class AnotherChart extends StatefulWidget {
 
  const AnotherChart.AnotherChart({super.key});

  @override
  _RevenueLineChartState createState() => _RevenueLineChartState();
}

class _RevenueLineChartState extends State<AnotherChart> {
  final BookingController bookingController = Get.find<BookingController>();
  

  // Track selected data type (bookings or mechanics)
  String selectedDataType = "Mechanics";
